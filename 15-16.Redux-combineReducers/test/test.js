...
describe('test combineReducers correct', () => {
  
  const todoApp = require('../lib/todo-app');
  // 初始化 填充state
...
describe(`test my combineReducers's implement correct`, () => {
  
  const myTodoApp = require('../lib/implement-combineReducers/my-todo-app');
  // 初始化 填充state
  const store = createStore(myTodoApp);
  
  it(`init myTodoApp State when the createStore(myTodoApp) called`, () => {
    // init
    const initialState = {
      todos: [],
      visibilityFilter: 'SHOW_ALL'
